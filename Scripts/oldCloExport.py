...
def processSewnEdges():
    for pairs in data["SeamLinePairGroupList"]:
        ...
        for pattern in iodtData["Pattern"]: 
            if iodtData["Pattern"][pattern]["PatternID"] == pp1: 
                p1Named = pattern
            if iodtData["Pattern"][pattern]["PatternID"] == pp2: 
                p2Named = pattern
            
        if [v1, v2] not in iodtData["Pattern"][p1Named]["SeamLinePairs"]: iodtData["Pattern"][p1Named]["SeamLinePairs"].append([v1, v2]) 
...
def findSelectedEquivalent(id):
     #print("in: ", id, patternPieceMap[id])
...
for pattern in patternPieces:
    ...
    iodtData["Pattern"][pattern]=getMetaData(pattern)
...
#print(pattern_api.GetSeamlinePairGroupListInPattern(pattern_api.GetPatternIndex("Pattern_3927253")))
#print(pattern_api.GetPatternInputInformation(pattern_api.GetPatternIndex("Pattern_3927253")))

#print(pattern_api.GetSeamlinePairGroupListInPattern(pattern_api.GetPatternIndex("Pattern_3927252")))
#print(pattern_api.GetPatternInputInformationW(pattern_api.GetPatternIndex("Pattern_3927252")))

#print(pattern_api.GetAllStitchProperty())
#print(pattern_api.GetPatternAssignedTopstitch(pattern_api.GetPatternIndex("Pattern_3927262")))
#print(pattern_api.GetPatternInformation(pattern_api.GetPatternIndex("Pattern_3927262")))

#print(pattern_api.GetArrangementOfPattern())
